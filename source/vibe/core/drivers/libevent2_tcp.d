...
package final class Libevent2TCPConnection : TCPConnection {
	...
	this(TCPContext* ctx)
	{
		...
		else if (ctx.remote_addr.family != AF_UNIX ) ptr = &ctx.remote_addr.sockAddrInet6.sin6_addr;
		else ptr = &ctx.remote_addr.sockAddrUnix.sun_path;
		...
		// TODO: do we need to set m_peerAddress in else case? (when family is AF_UNIX)
