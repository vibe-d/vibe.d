...
### Bug fixes ###
 ...
 - Fixed passing of misaligned base pointers to `free()` in `MallocAllocator` - at least 32-bit Linux seems to choke on it
 ...
 - Fixed handling of multiple cookies with the same name `HttpServerRequest.cookies.getAll()` can now be used to query them
...
[issue168]: https://github.com/rejectedsoftware/vibe.d/issues/169
