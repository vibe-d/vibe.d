...
### Features and improvements ###
 ...
 - Implemented zero-copy file transfers - [issue #143][issue143]
...
### Bug fixes ###
 ...
 - Fixed `listenTcp` without explicit bind address - now returns an array of listeners with one entry per protocol version
