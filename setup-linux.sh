...
MENU_FILE="$PREFIX/share/applications/vibe.d.desktop"
...
{
	# script help
	echo "Script to install and remove vibe.d on Linux."
	echo
	echo "Usage:"
	echo "  $0 [ -i | -r | -h ] "
	echo
	echo "Options:"
	echo "  -i     installs vibe.d"
	echo
	echo "  -r     removes vibe.d"
	echo
...
finstall()
{
	...
	chmod 0755 $(find $BASE_DIR/ -type d)
	chmod 0644 $(find $BASE_DIR/ ! -type d)
	...
	echo -e "\n \033[32;40;7;1m vibe.d installed successfully! \033[0m\n"
...
then
	echo -e "Must be run from vibe.d source root.\nExiting..." >&2
	exit 1
fi
